...
We want to create a newsfeed for each fellowship that shows new and relevant events.
...
Announcements can be addressed to a specific fellowship, or to all users (see table `news`, column `fellowship`). Founders are not interested in announcements addressed to writers, and so on.
...
- Don't download and display all entries at once, implement pagination + infinite scrolling.
...
Use a separate repo for the solution. Don't fork it, use this [guide for mirrorong a repo](https://docs.github.com/en/github/creating-cloning-and-archiving-repositories/duplicating-a-repository#mirroring-a-repository). If you add new steps necessary for setting up the project, erase the contents of this readme and describe those steps instead.

Send an email to your contact at On Deck that includes:

- a short Loom recording of UI and code walk-through,
- written answers for the questions,
- a link to the repo.
